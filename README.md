...
[![Open in Codespaces](https://classroom.github.com/assets/launch-codespace-2972f46106e565e64193e422d61a12cf1da4916b45550586e14ef0a7c637dd04.svg)](https://classroom.github.com/open-in-codespaces?assignment_repo_id=17483141)
...
2. **Scene Composition:**
   - Determine the last alphabet character of your name. For example, if your name is "DaniS," the last alphabet is "S." (Using Capital so it looks more visible)
   - Determine the last digit of your student ID. For example, if your student ID is `5025221239`, the last digit is `9`.
...
3. **Color Specification:**
   - Assign the alphabet mesh your favorite color from Assignment 1. (CodGray #0e0e0e)
   - Assign the digit mesh the complementary color of the alphabet’s color. (Putih #f1f1f1((255 - 14, 255 - 14, 255 - 14) = (241, 241, 241)))
...
5. **Shader Materials for Characters:**
   ...
   - **Alphabet ShaderMaterial:**
     - **Ambient:** Use an intensity of `0.abc`, where `abc = (last three digits of your Student ID) + 200`. For example, if the last three digits are `239`, then `abc = 439` and ambient intensity = `0.439`.
